...
{
	/// <summary>Implements the static Relations variant for the entity: Video. </summary>
	public partial class VideoRelations
	{
		...
		/// <summary>Gets all relations of the VideoEntity as a list of IEntityRelation objects.</summary>
