...
namespace LLBLGenTest.LLBL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private EntityCollection<PostEntity> _postCollectionViaPostTag;
		...
		public static partial class MemberNames
		{
			...
			/// <summary>Member name PostCollectionViaPostTag</summary>
			public static readonly string PostCollectionViaPostTag = "PostCollectionViaPostTag";
		...
		public TagEntity(System.Int32 tagId):base("TagEntity")
		{
			InitClassEmpty(null, CreateFields());
			this.TagId = tagId;
		}
		...
		/// <param name="validator">The custom validator object for this TagEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public TagEntity(System.Int32 tagId, IValidator validator):base("TagEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.TagId = tagId;
		}
		...
		public override void SetRelatedEntityProperty(string propertyName, IEntity2 entity)
		{
			switch(propertyName)
			{
				...
				case "PostTag":
					...
					break;
				case "PostCollectionViaPostTag":
					this.PostCollectionViaPostTag.IsReadOnly = false;
					this.PostCollectionViaPostTag.Add((PostEntity)entity);
					this.PostCollectionViaPostTag.IsReadOnly = true;
					break;
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			switch(fieldName)
			{
				...
				case "PostTag":
					toReturn.Add(TagEntity.Relations.PostTagEntityUsingFkTagId);
					break;
				case "PostCollectionViaPostTag":
					toReturn.Add(TagEntity.Relations.PostTagEntityUsingFkTagId, "TagEntity__", "PostTag_", JoinHint.None);
					toReturn.Add(PostTagEntity.Relations.PostEntityUsingFkPostId, "PostTag_", string.Empty, JoinHint.None);
					break;
		...
		public override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			if (SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				info.AddValue("_postCollectionViaPostTag", ((_postCollectionViaPostTag!=null) && (_postCollectionViaPostTag.Count>0) && !this.MarkedForDeletion)?_postCollectionViaPostTag:null);
		...
		public virtual IRelationPredicateBucket GetRelationInfoPostTag()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(PostTagFields.FkTagId, null, ComparisonOperator.Equal, this.TagId));
			return bucket;
		}
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoPostCollectionViaPostTag()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.Relations.AddRange(GetRelationsForFieldOfType("PostCollectionViaPostTag"));
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(LLBLGenTest.LLBL.EntityType.TagEntity);
		}
		...
		protected override void AddToMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue) 
		{
			...
			collectionsQueue.Enqueue(this._postCollectionViaPostTag);
		}
		...
		protected override bool HasPopulatedMemberEntityCollections()
		{
			...
			if (this._postCollectionViaPostTag != null)
			{
				return true;
			}
		...
		public override Dictionary<string, object> GetRelatedData()
		{
			...
			toReturn.Add("PostCollectionViaPostTag", _postCollectionViaPostTag);
		...
		protected override void AddInternalsToContext()
		{
			...
			if(_postCollectionViaPostTag!=null)
			{
				_postCollectionViaPostTag.ActiveContext = base.ActiveContext;
			}
		...
		protected virtual void InitClassMembers()
		{
			...
			_postTag = null;
			_postCollectionViaPostTag = null;
		...
		public static IPrefetchPathElement2 PrefetchPathPostTag
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<PostTagEntity>(EntityFactoryCache2.GetEntityFactory(typeof(PostTagEntityFactory))),
					(IEntityRelation)GetRelationsForField("PostTag")[0], (int)LLBLGenTest.LLBL.EntityType.TagEntity, (int)LLBLGenTest.LLBL.EntityType.PostTagEntity, 0, null, null, null, null, "PostTag", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		/// for this entity. Add the object returned by this property to an existing PrefetchPath2 instance.</summary>
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathPostCollectionViaPostTag
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<PostEntity>(EntityFactoryCache2.GetEntityFactory(typeof(PostEntityFactory))), intermediateRelation,
					(int)LLBLGenTest.LLBL.EntityType.TagEntity, (int)LLBLGenTest.LLBL.EntityType.PostEntity, 0, null, null, GetRelationsForField("PostCollectionViaPostTag"), null, "PostCollectionViaPostTag", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		/// <summary> The Title property of the Entity Tag<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "Tag"."Title"<br/>
		/// Table field type characteristics (type, precision, scale, length): VarChar, 0, 0, 200<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual System.String Title
		{
			get { return (System.String)GetValue((int)TagFieldIndex.Title, true); }
			set	{ SetValue((int)TagFieldIndex.Title, value); }
		}

		/// <summary> The Description property of the Entity Tag<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "Tag"."Description"<br/>
		/// Table field type characteristics (type, precision, scale, length): VarChar, 0, 0, 2147483647<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual System.String Description
		{
			get { return (System.String)GetValue((int)TagFieldIndex.Description, true); }
			set	{ SetValue((int)TagFieldIndex.Description, value); }
		}

		/// <summary> The Slug property of the Entity Tag<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "Tag"."Slug"<br/>
		/// Table field type characteristics (type, precision, scale, length): VarChar, 0, 0, 200<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual System.String Slug
		{
			get { return (System.String)GetValue((int)TagFieldIndex.Slug, true); }
			set	{ SetValue((int)TagFieldIndex.Slug, value); }
		}

		/// <summary> The IsActive property of the Entity Tag<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "Tag"."IsActive"<br/>
		/// Table field type characteristics (type, precision, scale, length): Bit, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.Boolean> IsActive
		{
			get { return (Nullable<System.Boolean>)GetValue((int)TagFieldIndex.IsActive, false); }
		...
		public virtual EntityCollection<PostTagEntity> PostTag
		{
			get
			{
				if(_postTag==null)
				{
					...
					_postTag.SetContainingEntityInfo(this, "Tag");
				}
				return _postTag;
			}
		}
		...
		public virtual EntityCollection<PostEntity> PostCollectionViaPostTag
		{
			get
			{
				if(_postCollectionViaPostTag==null)
				{
					_postCollectionViaPostTag = new EntityCollection<PostEntity>(EntityFactoryCache2.GetEntityFactory(typeof(PostEntityFactory)));
					_postCollectionViaPostTag.IsReadOnly=true;
				}
				return _postCollectionViaPostTag;
			}
		}
		...
		{ 
			get { return (int)LLBLGenTest.LLBL.EntityType.TagEntity; }
		}
		#endregion
